...
const SearchBar = ({ searchTerm, setSearchTerm }) => {
  return (
    <div className="relative w-full max-w-md">
      ...
      />
      <div className="absolute right-3 top-1/2 flex -translate-y-1/2 items-center rounded border border-gray-800 bg-gray-900 px-1.5 py-0.5 text-[10px] text-gray-400">
        ⌘ K
      </div>
    </div>
  );
